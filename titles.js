...
function generateContent() {
	...
	const content = {
		...
		"virtual-tours": {
			...
			description: `Take a virtual ${propertyType.toLowerCase()} tour of ${propertyName} in ${city}, ${state}, and look through one of our ${propertyType.toLowerCase()}s from the comfort of your own home!`,
			content: `Take a virtual ${propertyType.toLowerCase()} tour of ${propertyName} in ${city}, ${state} and look through one of our ${propertyType.toLowerCase()}s from the comfort of your own home! Our virtual tours highlights all the features of our stunning ${city} ${propertyType.toLowerCase()}s and amenities.`,
		},
		"pet-friendly": {
			page: "Pet Friendly",
			title: "Pet Policy at ",
